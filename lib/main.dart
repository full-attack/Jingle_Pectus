...
import 'package:chatting/screens/splash_page.dart';
import 'package:chatting/utilities/theme.dart';

void main() async {
  WidgetsFlutterBinding.ensureInitialized();
  await Firebase.initializeApp(name:'chatting', options: DefaultFirebaseOptions.currentPlatform);
