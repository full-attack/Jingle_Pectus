...
import 'package:chatting/allConstants/app_constants.dart';
...
import 'package:chatting/allConstants/color_constants.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void updateFirestoreData() {
    ...
    setState(() {
      isLoading = true;
      if (dialCodeDigits != "+7" && _phoneController.text != "") {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          const Text('Имя', style: TextStyle(
                          ...
                          vertical15,
                          const Text('Немного информации о Вас...', style: TextStyle(
                            fontStyle: FontStyle.italic,
                            fontWeight: FontWeight.bold,
                            color: AppColors.someWhite
                          ),),
                          ...
                          vertical15,
                          const Text('Выберите код страны', style: TextStyle(
                            fontStyle: FontStyle.italic,
                            fontWeight: FontWeight.bold,
                            color: AppColors.someWhite,
                          ),),
                      ...
                      ElevatedButton(
                        ...
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all(Color(0xff84b0ff)),),
                          child:const Padding(
